...
<div class="container-fluid">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><?= $title ?? 'Modifier un étudiant' ?></h1>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <form action="/srx/pilot_students/edit/<?= $student['id'] ?>" method="POST" class="needs-validation" novalidate>
                        <div class="mb-3">
                                ...
                                <?php if (!empty($promotions)): ?>
                                    <?php foreach ($promotions as $promotion): ?>
                                        <option value="<?= $promotion['id'] ?>" 
                                                <?= ($student['promotion_id'] == $promotion['id']) ? 'selected' : '' ?>>
