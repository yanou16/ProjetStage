<div class="company-edit-section">
    <div class="header-section">
        <div class="header-content">
            <h1 class="company-title">Modifier l'entreprise : <?= htmlspecialchars($company['name']) ?></h1>
        </div>
    </div>
                ...
                <div class="info-card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="/srx/companies/edit/<?= $company['id'] ?>" class="needs-validation" novalidate>
                            ...
                            <div class="form-section">
                                <h5 class="section-title">Historique</h5>
                                <div class="history-info">
                                    <p><i class="fas fa-calendar-plus"></i> Créé le : <?= date('d/m/Y H:i', strtotime($company['created_at'])) ?></p>
                                    <?php if (isset($company['updated_at'])): ?>
                                        <p><i class="fas fa-calendar-check"></i> Dernière modification : <?= date('d/m/Y H:i', strtotime($company['updated_at'])) ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <div class="sidebar">
                ...
                <div class="info-card">
                    <div class="card-body">
                        ...
                        <ul class="info-list">
                            <li><i class="fas fa-briefcase"></i> Offres de stage : <?= $company['internship_count'] ?? 0 ?></li>
                            <li><i class="fas fa-file-alt"></i> Candidatures reçues : <?= $company['application_count'] ?? 0 ?></li>
                            <li><i class="fas fa-star"></i> Note moyenne : <?= number_format($company['avg_rating'] ?? 0, 1) ?>/5</li>
                        </ul>
                    </div>
                </div>
...
<script>
// Validation du formulaire (conservée avec amélioration visuelle)
(function () {
    'use strict'
